...
#include "CyphersStageGimmick.generated.h"
...
UCLASS()
class CYPHERS_API ACyphersStageGimmick : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ACyphersStageGimmick();
...
protected:
	...
	TSubclassOf<class ACyphersCharacterNonPlayer> OpponentClass;
...
protected:
	...
	TSubclassOf<class ACyphersItemBox> RewardBoxClass;

	UPROPERTY(VisibleAnywhere, Category = Reward, Meta = (AllowPrivateAccess = "true"))
	TArray<TWeakObjectPtr<class ACyphersItemBox>> RewardBoxes;
